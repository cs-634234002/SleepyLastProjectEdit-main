    ...
    <ul class="nav flex-column">
      ...
      <li class="nav-item">
        <a class="nav-link" href="service.php">
          <i class="bi bi-person-square"></i> ข้อมูลบริการ
        </a>
      </li>

      <li class="nav-item">
        <a class="nav-link" href="/booking/index.php">
          <i class="bi bi-person-square"></i> ตารางปฎิทิน
        </a>
      </li>

      <li class="nav-item">
        <a class="nav-link" href="ncx.php">
          <i class="bi bi-person-square"></i> สถานะการใช้บริการ
        </a>
      </li>
